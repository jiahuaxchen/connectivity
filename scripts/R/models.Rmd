...
#need to add min_na, understand why bike has n=95
#

datasummary(cnnctvt + b_net_dens + b_gamma + b_cover + b_int_dens + b_complex +ls_net_den + ls_gamma + ls_cover + ls_int_den + ls_complex ~ Mean + SD + Min +Median + Max + Histogram,data = connectivity_measures_df,output = 'result_tables/summary_table_v2.docx')
```
